...
_WidgetManager._GetAllData().blog.pageType&&(e=a("a.blog-pager-older-link").attr("href"))){var f=a('<a href="javascript:;">Load more posts</a>');f.click(d);var h=a('<img src="https://1.bp.blogspot.com/-Be3iXNwLy7U/W67AapH7uxI/AAAAAAAAAZg/-2dfsG80v7w5PIS-qq_TZ0DJmcVp9oVtACKgBGAs/s1600/ajax-loader.gif" style="display: none;">');g.scroll(b);c=a('<div style="text-align: center; font-size: 150%;"></div>');c.append(f);c.append(h);c.insertBefore(a("#blog-pager"));a("#blog-pager").hide()}})})(jQuery);
